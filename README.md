...
- 🩺 **Anemo Check** — AI-powered non-invasive anemia screening PWA, offline-first, Gemini/Gemma powered
- 📊 **Churn Prediction System** — Random Forest classification pipeline for customer retention strategy
